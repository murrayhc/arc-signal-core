...
export const Route = createFileRoute("/ask-graph")({
  head: () => ({
    meta: [
      { title: "Archlight · Ask the graph" },
      { name: "description", content: "Ask plain-English questions of Archlight's world model. Answers come from deterministic, cited graph queries — the AI only maps the question to a fixed query intent." },
      { property: "og:title", content: "Archlight · Ask the graph" },
